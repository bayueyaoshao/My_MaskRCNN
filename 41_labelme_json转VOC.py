...
# 1.标签路径
labelme_path = r"./Json/"  # 原始labelme标注数据路径
saved_path = r"./VOC2012/"  # 保存路径
...
if not os.path.exists(saved_path + "ImageSets/Segmentation/"):
    os.makedirs(saved_path + "ImageSets/Segmentation/")
...
txtsavepath = saved_path + "ImageSets/Segmentation/"
